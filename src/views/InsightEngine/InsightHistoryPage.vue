            ...
            <td>
              <div class="project-info">
                ...
                <div class="project-details">
                  <div class="project-name">{{ record.run_name || '未命名分析' }}</div>
...
const loadHistory = async () => {
  ...
  try {
    ...
    // 构建查询参数 - 洞察引擎的agent_id
    const params = new URLSearchParams({
      agentId: '1', // 洞察引擎的agent_id
