            ...
            <td>
              <div class="project-info">
                ...
                <div class="project-details">
                  <div class="project-name">{{ record.run_name || '未命名叙事' }}</div>
...
const loadHistory = async () => {
  ...
  try {
    ...
    // 构建查询参数 - 叙事引擎的agent_id
    const params = new URLSearchParams({
      agentId: '2', // 叙事引擎的agent_id
